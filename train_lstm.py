...
class Vectorizer(object):
    ...
    def train_model(self):
        ...
        import mlflow
        import mlflow.keras
        mlflow.set_tracking_uri("http://78.47.18.26:5000/")
        os.environ["MLFLOW_TRACKING_URI"] = "http://78.47.18.26:5000/"
        os.environ["MLFLOW_S3_ENDPOINT_URL"] = "http://78.47.18.26:9000"
        os.environ["AWS_SECRET_ACCESS_KEY"] = "minio_secret_key"
        os.environ["AWS_ACCESS_KEY_ID"] = "minio_access_key"
        print(scores)
        mlflow.log_param("loss", scores[0])
        mlflow.log_param("Accuracy", scores[1])
